<!-- <h1 class="bg-rose-500 text-3xl font-bold underline hover:text-cyan-400">
        Hello world!
    </h1> -->
<div class="container my-4 mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
    <div class="bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl">
        ...
        <div class="mt-10 flex items-center justify-center">
            <a href=""
                class="rounded-md bg-indigo-600 px-3 py-3 text-sm font-semibold hover:bg-indigo-400 text-white">Get
                Started</a>
        </div>
    </div>
