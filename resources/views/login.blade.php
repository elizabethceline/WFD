...
@section('content')
    @if (session('error'))
        <div id="error-alert"
            class="fixed mx-auto mt-4 w-1/3 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded shadow-md"
            role="alert">
    ...
    <div class="container my-4 mx-auto">
        <form action="{{ route('login.auth') }}" method="POST" enctype="multipart/form-data">
            <h2 class="text-base font-semibold text-gray-700">LOGIN YANG BENER WOI</h2>
            @csrf
